    ...
    return (
        <footer className="footer footer-center p-10 bg-base-200 text-base-content rounded-xl">
            <div>
                ...
                <a href="https://github.com/mamun-prodhan" target="_blank" rel="noopener noreferrer"><FaGithubSquare className='w-8 h-8'/></a>
                <a href="https://www.linkedin.com/in/mamunprodhan/" target="_blank" rel="noopener noreferrer"><FaLinkedin className='w-8 h-8'/></a>
                </div>
            </div>
            <div>
                <p>Copyright © 2022 - All right reserved by Mamun Prodhan</p>
            </div>
        </footer>
    );
};
